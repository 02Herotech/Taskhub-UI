...
const ChangePassword = () => {
  ...
  return (
    <CustomerDashboardLayout>
      <div
        className={`mt-16 flex flex-col justify-center items-start w-[800px]`}
      >
        <h1 className="text-lg font-extrabold">Settings</h1>

        <div
          className={`flex justify-around items-start mt-20 w-[800px] mx-auto`}
        >
          <div className="flex flex-col justify-center items-center bg-white shadow-lg w-[220px] py-5 text-[15px]">
            <div className="flex flex-col justify-center items-start">
              <Link
                href="/dashboard/customer/settings/change-password"
                className={`flex items-center justify-center gap-[8px] hover:text-[#FE9B07] px-1 py-2 mx-1 my-2 ${
                  isLinkActive(
              ...
              <Link
                href="/dashboard/customer/settings/deactivate"
                className={`flex items-center justify-center gap-[8px] hover:text-[#FE9B07] px-1 py-2 mx-1 my-2 ${
                  isLinkActive("/dashboard/customer/settings/deactivate") &&
                  "text-[#FE9B07]"
                }`}
              >
                <LuUsers />
            ...
            {isSuccessful ? (
              ...
              >
                ...
                <p className="text-center mt-10">
                  Please check the email sent to you to confirm password change
                </p>
                <p className="text-center my-10">
                  You'll be logged out in {secondsLeft > 0 && `${secondsLeft}`}{" "}
                  sec
                </p>
              </div>
            ) : (
                ...
                <form className={` p-5`} onSubmit={handleSubmit}>
                  ...
                  <div className={`flex flex-col my-3`}>
                    ...
                    >
                      ...
                      <span className={`text-red10`}>*</span>
                      <p
                        className={`text-red10 p-2  my-0 py-0 text-[10px] w-[230px] text-justify`}
                      >
                        {formData.error1}
                      </p>
                    </label>
                  ...
                  <div className={`flex justify-center items-center mt-10`}>
                    <button
                      ...
                      disabled={
                        !isAllFieldsFilled() || isLoading || notEmptyError2
                      }
                    >
