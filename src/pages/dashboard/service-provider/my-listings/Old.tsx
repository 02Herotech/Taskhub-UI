...
const Listings = () => {
  ...
  // const handleCheckBoxChange = (day: string) => {
  //   // Convert the string day to enum value
  //   const enumDay = AvailableDays[day as keyof typeof AvailableDays];

  //   if (enumDay) {
  //     setFormData((prevState) => ({
  //       ...prevState,
  //       availableDays: prevState.availableDays.includes(enumDay)
  //         ? prevState.availableDays.filter(
  //             (checkedDay) => checkedDay !== enumDay
  //           )
  //         : [...prevState.availableDays, enumDay],
  //     }));
  //   }
  // };
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    // Convert availableDays array to array of string enum values
    // const availableDaysEnumValues = formData.availableDays.map(
    ...
    // apiFormData.append(
    //   "availableDays",
    //   JSON.stringify(availableDaysEnumValues)
    // );
