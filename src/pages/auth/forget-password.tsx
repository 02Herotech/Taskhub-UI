...
const ForgetPassword = () => {
  ...
  return (
    <div className={`m-auto`}>
      ...
      <div
        className={`flex min-h-screen  justify-center items-center flex-col m-auto pt-20 `}
      >
        {isSuccessful ? (
          <div
          ...
          >
            ...
            <p className="text-center mt-10">
              Kindly use the link sent to your email to reset your password
            </p>
          </div>
        ) : (
          <div>
            ...
            <form
              action=""
              onSubmit={onSubmit}
              className={`space-y-5 p-2 w-[400px]`}
            >
              ...
              <div
                className={`flex justify-center items-centerw-[400px] text-sm`}
              >
                <button
                  type="submit"
        ...
        <div
          className={`flex justify-around items-center font-bold space-x-1 mt-5 text-base w-[150px] h-[30px] `}
        >
          <Link
            href="/auth/login"
            className={`text-purpleBase hover:text-[16px] hover:underline`}
          >
            Back to Log in
          </Link>
        </div>
