    ...
    <div>
      ...
      <div className={`text-justify pb-20 pt-36 px-20 max-w-7xl mx-auto`}>
        ...
        <div className="text-base px-20">
          <p>
            Here are our terms and conditions. Country Specific Terms in
            Appendix B shall also apply to this Agreement. Please contact us
            here if you have any other questions. Thanks for connecting.
          </p>
          <p className="my-5">
            The TaskHub terms & conditions (updated date) outline TaskHub and
            Your obligations and responsibilities on the TaskHub Platform. In
            this update to our Terms and Conditions, TaskHub has updated
          ...
          <p className="my-5">
            TaskHub operates an online platform allowing Users to connect
            through the TaskHub Platform with other Users who provide Services.
          </p>
          <p>
          ...
          <p className="my-5">
            All defined terms in this Agreement have the meaning given to them
            in the TaskHub Glossary.
          </p>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              {" "}
              <span className="mr-2">1.2</span>Service Providers may make an
              Offer in response to a Posted service. Some parts of Offer details
              may be made publicly available, including to internet users who
              are not Users.
            </li>
            <li className="flex">
              {" "}
              ...
              reserves the right to cancel all Offers on a Posted Task made
              prior to the modification.
            </li>

            <li className="flex">
              <span className="mr-2">1.4</span> If a Poster accepts an Offer on
              the TaskHub Platform, a Task Contract is created between the
              service and the Poster.
            </li>
            <li className="flex">
              <span className="mr-2">1.5</span> Upon creation of a Task
              Contract, the Poster must pay the Agreed Price into the Payment
              Account.
            </li>
            <li className="flex">
              <span className="mr-2">1.6</span> Upon creation of the Task
              Contract, TaskHub has rendered TaskHub Services and the Service
              Fee is due and payable.
            </li>
            <li className="flex">
              <span className="mr-2">1.7</span> Once the Task Contract is
              created, the Tasker and Poster may vary the Task Contract on the
              TaskHub Platform. The Poster and Tasker are encouraged to use
              TaskHub’s private messaging system to amend or vary the Task
              Contract (including the Agreed Price) or to otherwise communicate.
            </li>
            <li className="flex">
            ...
            <li className="flex">
              <span className="mr-2">1.9</span>Once the Services are complete,
              the Poster must provide notice of that on the TaskHub Platform.
            </li>
            <li className="flex">
              <span className="mr-2">1.10</span> Once the Posted Task has been
              completed and the Poster confirms the Services are completed, or
              if TaskHub is satisfied with the Services have been completed, the
              Tasker Funds will be released by TaskHub from the Payment Account
              to the Tasker. However, this process does not apply to the payment
              of Recurring Services which is addressed in clause 1.20 below.
            </li>
            <li className="flex">
              <span className="mr-2">1.11</span> After the Task Contract is
              completed, the parties are encouraged to review and provide
              feedback of the Services on the TaskHub Platform.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              TaskHub may also provide a Search Assist feature enabling Posters
              to submit an Offer for Services.
            </li>
            <li className="flex">
              <span className="mr-2">1.13</span>
              An Offer submitted by a Poster using Search Assist may be notified
              to other Users and such Users may elect to make an Instant Claim
              of it.
            </li>
            <li className="flex">
              <span className="mr-2">1.14</span>
              When using Search Assist a Task Contract is created when a Tasker
              makes an Instant Claim (and in the case of Recurring Services a
              Task Contract is created for the first Occurrence only). For
              Recurring Services, the next Task Contract is created upon
              completion of the previous Occurrence.
            </li>
            <li className="flex">
              <span className="mr-2">1.15</span>A Poster may revoke or modify
              its Offer in using Search Assist, including for Recurring
              Services, at any time before a Tasker makes an Instant Claim.
              TaskHub reserves the right to cancel all Posted Tasks made prior
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              TaskHub may also provide a service provider Listing feature
              enabling the service provider to publish Offers for Services.
            </li>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Occurrence has been completed and the Tasker confirms the
              Occurrence is completed (or if TaskHub is satisfied the Occurrence
              is completed) then the Tasker Funds for that Occurrence will
              automatically be released by TaskHub from the Payment Account to
              the Tasker.
            </li>
            <li className="flex">
              <span className="mr-2">1.21</span>
              The Poster may elect to pause automatic payment of Tasker Funds
              for an Occurrence within 24 hours from when the Tasker confirms
              the Occurrence is completed. If the Poster pauses such automatic
              payment in accordance with this clause, then the Tasker Funds will
              not be released by TaskHub from the Payment Account to the Tasker
              until the Poster also confirms that the Occurrence is completed.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              ...
              or modify any existing account including if TaskHub reasonably
              forms the view that a User's conduct (including a breach of this
              Agreement) is detrimental to the operation of the TaskHub
              Platform.
            </li>
            <li className="flex">
              <span className="mr-2">2.5</span>
              Registering and creating an account with TaskHub is free. There is
              no charge for a Poster to post tasks, or for other TaskHub Users
              to review content on the TaskHub Platform, including Posted Tasks.
            </li>
            <li className="flex">
              <span className="mr-2">2.6</span>
              TaskHub accepts no liability for any aspect of the Poster and
            ...
            <li className="flex">
              ...
              TaskHub has no responsibility and makes no warranty as to the
            ...
            <li className="flex">
              ...
              the TaskHub Service is provided on an "as is" basis, and without
              any warranty or condition, express or implied. To the extent
            ...
            <li className="flex">
              ...
              TaskHub has no obligation to any User to assist or involve itself
              in any dispute between Users, although may do so to improve User
              experience.
            </li>
            <li className="flex">
              ...
              agree that you are solely responsible for conducting any
              appropriate background checks and obtaining references, licenses,
              certifications, or proof of insurance prior to engaging a tasker
              to perform services. You further understand and agree that you are
              ...
              TaskHub from any and all loss, liability, injury, death, damage,
              or costs arising or in any way related to the services.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              {" "}
              <span className="mr-2">(b)</span> only post accurate information
              on the TaskHub Platform;
            </li>
            <li className="flex">
              {" "}
              <span className="mr-2"> (c)</span>
              ensure that You are aware of any laws that apply to You as a
              Poster or Tasker, or in relation to using the TaskHub Platform.
            </li>
            <li className="flex">
              <span className="mr-2">3.2</span>
              You agree that any content (whether provided by TaskHub, a User or
              a third party) on the TaskHub Platform may not be used on third
              party sites or for other business purposes without TaskHub prior
              permission.
            </li>
            <li className="flex">
            ...
            <li className="flex">
              ...
              You must maintain control of Your TaskHub account at all times.
            ...
            <li className="flex">
              ...
              material on the TaskHub Platform and as otherwise may be required
              to provide the TaskHub Service, for the general promotion of the
            ...
            <li className="flex">
              <span className="mr-2">(a)</span> be false, inaccurate or
            ...
            <li className="flex">
              ...
              rights, rights of publicity, confidentiality or privacy;
            </li>
            <li className="flex">
            ...
            <li className="flex">
              ...
              damage, modify, delete, detrimentally interfere with,
            ...
            <li className="flex">
              ...
              Platform. A User should never disclose personal details such as
              the Poster's full name, street number, phone number or email
              address in a Posted Task or in any other public communication on
            ...
            <li className="flex">
              ...
              top of the Tasker Funds. However, the parties to a Task Contract
              may agree to amend the Agreed Price through the TaskHub Platform.
            </li>
            <li className="flex">
              <span className="mr-2">3.11</span>
              You must not request payments outside of the TaskHub Platform from
              the Poster for the Services except to the extent permitted by
              clause 3.12 and only if the TaskHub Platform does not facilitate
              the reimbursement via the Payment Account of costs considered in
              clause 3.12.
            </li>
            <li className="flex">
              ...
              responsible for obtaining any reimbursement from the Poster.
              TaskHub advises Taskers not to agree to incur costs in advance of
              receiving the payment for these costs, unless the Tasker is
              confident the Poster will reimburse the costs promptly.
            </li>
            <li className="flex">
              <span className="mr-2">3.13</span>
              For the proper operation of the TaskHub Platform (including
              insurance, proper pricing and compliance with Policies), the
              Tasker must ensure that, if it subcontracts any part of the
              performance of the Services to a third party in accordance with a
              Task Contract, then that third party must also be a registered
              User of the TaskHub Platform.
            </li>
            <li className="flex">
              <span className="mr-2">3.14</span>
              If TaskHub determines at its sole discretion that You have
              ...
              TaskHub Service or cancel or suspend Your account and/or any Task
              Contracts.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              <span className="mr-2">4.1</span>A Poster Service Fee is payable
              to TaskHub in respect of bookings made on the Platform. When a
              Customer accepts a Tasker's offer a Task Contract is formed
              between the two parties. At this time the Customer will be charged
              the Agreed Price plus the Poster Service Fee.
            </li>
            <li className="flex">
              <span className="mr-2">4.2</span>
              When a Customer releases the Task Payment to the Tasker, the
              Tasker Service Fee and the Poster Service Fee will be retained by
              TaskHub.
            </li>
            <li className="flex">
            ...
            <li className="flex">
              ...
              Fees applying to that service will be payable from the launch of
              the service.
            </li>
            <li className="flex">
              <span className="mr-2">4.6</span>
              TaskHub reserves the right to amend the amount of the Poster
              Service Fee from time to time and any changes will be updated on
              TaskHub's website.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Agreed Price should be returned to the Poster then the Agreed
              Price will be refunded to the Poster as Stored Value and a
              Cancellation Admin Fee will be due to TaskHub by the User who the
              cancellation of the Task Contract is attributable to under clause
              5.5 or 5.6.
            </li>
            <li className="flex">
              {" "}
              ...
              Price back onto the Poster's credit card instead of Stored Value
              or waive the Cancellation Admin Fee.
            </li>
            <li className="flex">
              {" "}
              ...
              may be offset by TaskHub against any other payments owed at any
              time to the Tasker.
            </li>
            <li className="flex">
              {" "}
              ...
              offset by TaskHub against any other payments owed at any time to
              the User.
            </li>
            <li className="flex">
              {" "}
            ...
            <li className="flex">
              {" "}
              <span className="mr-2">(a)</span>
              the Poster cancels the Task Contract (other than in accordance
            ...
            <li className="flex">
              ...
              TaskHub may take up to 14 days to return the Agreed Price (less
            ...
            <li className="flex">
              ...
              otherwise made to the Tasker or returned to the Poster (as the
              case may be) or no claim is otherwise made for the Tasker Funds,
              the Tasker Funds will remain in the Payment Account until paid or
              otherwise for up to three months from the date the Poster
              initially paid the Agreed Price into the Payment Account.
            </li>
            <li className="flex">
              {" "}
              <span className="mr-2">5.10</span>
              Following the 3 months referred to in clause 5.9, and provided
              there is still no dispute in respect of the Tasker Funds, the
              Tasker Funds will be credited to the Poster as Stored Value.
            </li>
            <li className="flex">
              {" "}
              ...
              commenced, then the amount of the Agreed Price to be returned to
              the Poster will be conditional upon the mediation and dispute
              process in clause 18. However, the Cancellation Admin Fee will
              always be due in accordance with clause 5.1.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              <span className="mr-2">(a)</span>
              can be used by the credited User to pay for any new Services via
              the TaskHub Platform;
            </li>
            <li className="flex">
              <span className="mr-2">(b)</span>
            ...
            <li className="flex">
              <span className="mr-2">(c)</span>
              cannot be replaced, exchanged or reloaded or transferred to
            ...
            <li className="flex">
              ...
              purchase or any expiry date applied by TaskHub (conditional upon
              any contrary specific jurisdictional legislative requirements);
            </li>
            <li className="flex">
              <span className="mr-2">(e)</span>
              if the Stored Value is acquired other than under this Agreement,
              it may also be conditional on compliance with additional, or
              different, terms and conditions, as specified in relation to
              Stored Value, such as a restriction on when the Stored Value is
              redeemable (for example only for a User's first Task Contract),
              specify a minimum Services value, or specify a maximum credit or
              discount value; and
            </li>
            <li className="flex">
              <span className="mr-2">(f)</span>
              must not be reproduced, copied, distributed, or published directly
              or indirectly in any form or by any means for use by an entity
              other than the credited User, or stored in a data retrieval
              system, without TaskHub 's prior written permission.
            </li>
            <li className="flex">
              <span className="mr-2">6.2</span>
              The User credited with a Stored Value is solely responsible for
              the security of any Stored Value. Save for the Non-Excludable
              Conditions, TaskHub will have no liability for any loss or damage
              to the Stored Value and does not have any obligation to replace
              Stored Value.
            </li>
            <li className="flex">
              <span className="mr-2">6.3</span>
              TaskHub will not accept, and may refuse or cancel, any Stored
              Value, which it reasonably determines in its discretion, have been
              used in breach of this Agreement or have been forged, tampered
              with, or are otherwise fraudulent and TaskHub reserves the right
              to refer any suspected fraudulent activity to relevant law
              enforcement authorities. In particular, Stored Value, such as
              promotional coupons, vouchers or codes distributed or circulated
              without our approval, for example on an internet message board or
              on a "bargains" website, are not valid for use and may be refused
              or cancelled.
            </li>
            <li className="flex">
              <span className="mr-2">6.4</span>
              TaskHub is entitled to any value on Stored Value which is not
              redeemed before the Stored Value expires or is cancelled by
              TaskHub.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Taskers who agree to perform Business Services for Business
              Partners acknowledge and agree that TaskHub and the Business
              Partner may on-sell Services supplied to third parties for an
              increased fee.
            </li>
            <li className="flex">
              <span className="mr-2">7.2</span>
              Business Partners may require Taskers providing Business Services
              to be approved or hold particular qualifications. TaskHub may
              assist Business Partners to locate suitably qualified Taskers.
              TaskHub makes no warranty that it will promote any or all suitably
            ...
            <li className="flex">
              <span className="mr-2">(a)</span>
              the Tasker must provide Business Services to the Business Partner
              in accordance with the Task Contract and any applicable Business
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              ...
              Account, the terms at (http of the payment processor) are
              incorporated into this Agreement and will prevail over this
            ...
            <li className="flex">
              ...
              If TaskHub changes its Payment Provider You may be asked to agree
              to any further additional terms with those providers. If you do
              not agree to them, you will be given alternative means of payment.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              ...
              TaskHub Identity Verification Services may be modified at any
              time.
            </li>
            <li className="flex">
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              ...
              TaskHub is entitled to suspend or terminate Your account at any
              time if TaskHub, in its sole and absolute discretion, is concerned
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Third Party Service providers will provide their service pursuant
              to their own Privacy Policy. Prior to acceptance of any service
              from a third party, you must review and agree to their terms of
              service including their privacy policy.
            </li>
            <li className="flex">
              ...
              order to ensure TaskHub can reduce the incidence of fraud and
              other behavior in breach of the Community Guidelines, TaskHub
              reserves the right to ask Users to verify themselves in order to
              remain a User.
            </li>
          </ul>
          <p className="font-extrabold my-4">
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              TaskHub will send notification of such modifications to Your
              TaskHub account or advise You the next time You login.
            </li>
            <li className="flex">
              <span className="mr-2">14.2</span>
              When You actively agree to amended terms (for example, by clicking
              a button saying "I accept") or use the TaskHub Platform in any
              manner, including engaging in any acts in connection with a Task
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Except as stated otherwise, any notices must be given by
              registered ordinary post or by email, either to Task Hub’s contact
              address as displayed on the TaskHub Platform, or to TaskHub Users'
            ...
            <li className="flex">
              ...
              posting, or on the seventh Business Day after the date of posting
              if sent to or posted from outside the jurisdiction in which You
              have Your TaskHub Platform account.
            </li>
            <li className="flex">
              <span className="mr-2">15.2</span>
              Notices related to performance of any Third Party Service must be
              delivered to such third party as set out in the Third Party
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              TaskHub encourages You to try and resolve disputes (including
              claims for returns or refunds) with other Users directly.
              Accordingly, you acknowledge and agree that TaskHub may, in its
            ...
            <li className="flex">
              ...
              If a dispute arises with another User, you must co-operate with
            ...
            <li className="flex">
              ...
              information supplied by the Users and direct the Payment Provider
              to make payment accordingly. You may raise your dispute with the
              other User or TaskHub 's determination in an applicable court or
              tribunal.
            </li>
            <li className="flex">
            ...
            <li className="flex">
              ...
              TaskHub may provide access to a Third Party Dispute Service. If
              such a service is provided, either party may request the other
              party to submit to the Third Party Dispute Service if the parties
              have failed to resolve the dispute directly. Terms and conditions
              for the Third Party Dispute Service will be available on request.
              The Third Party Dispute Service is a Third Party Service and Users
              are responsible for paying any costs associated with the Third
              Party Dispute Service in accordance with the Third Party Dispute
            ...
            <li className="flex">
              ...
              If You have a complaint about the TaskHub Service please contact
              us here.
            </li>
            <li className="flex">
              ...
              and agree that such information will be used only for the purpose
              of resolving the dispute (and no other purpose) and that you will
              be responsible and liable to TaskHub for any costs, losses or
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Either You or TaskHub may terminate your account and this
              Agreement at any time for any reason.
            </li>
            <li className="flex">
              <span className="mr-2">17.2</span>
              Termination of this Agreement does not affect any Task Contract
              that has been formed between TaskHub Users.
            </li>
            <li className="flex">
            ...
            <li className="flex">
              ...
              should continue to apply, will survive any termination or
              expiration of this Agreement.
            </li>
            <li className="flex">
              <span className="mr-2">17.5</span>
              If Your account or this Agreement are terminated for any reason
              then You may not without TaskHub's consent (in its absolute
              discretion) create any further accounts with TaskHub and we may
          ...
          <p className="my-4">
            ...
            TaskHub Agreement. Unless otherwise agreed, the Poster and the
            Tasker enter into a Task Contract on the following terms:
          </p>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            ...
            <li className="flex">
              ...
              The Task Contract will continue until terminated in accordance
              with clause 7.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              <span className="mr-2"> 2.1</span>
              The Tasker will perform Services in a proper and workmanlike
              manner.
            </li>
            <li className="flex">
              <span className="mr-2">2.2</span>
            ...
            <li className="flex">
              ...
              other terms or conditions agreed by the parties during or
            ...
            <li className="flex">
              ...
              Services. Therefore, the Tasker must not subcontract any part of
              the Services to any third party without the Poster's consent.
            </li>
            <li className="flex">
              <span className="mr-2">2.4</span>
              The Tasker remains responsible and liable at all times to the
              Poster for any acts or omissions of a subcontractor as if those
              acts or omissions had been made by the Tasker.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Each party warrants that the information provided in the creation
              of the Task Contract is true and accurate. 3.2 The Tasker warrants
              that they have (and any subcontractor has) the right to work and
              provide Services and hold all relevant licenses in the
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              the Tasker Funds for an Occurrence will automatically be released
              by TaskHub from the Payment Account to the Tasker unless paused by
              the Poster in accordance with the User's TaskHub Agreement. 4.4 If
              the parties agree to cancel the Task Contract, or the Poster is
              unable to contact the Tasker to perform the Task Contract, the
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              Condition, the parties exclude all Consequential Loss arising out
              of or in connection to the Services, and any claims by any third
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              ...
              If a dispute arises between the parties, the parties will attempt
              to resolve the dispute within 14 days by informal negotiation (by
              phone, email or otherwise). 6.2 If the parties are unable to
              resolve the dispute in accordance with clause 6.1, either party
              may refer the dispute to TaskHub and act in accordance with clause
              18 of the TaskHub Agreement.
            </li>
          </ul>
          ...
          <ul className="ml-4 text-[12px] flex flex-col space-y-2 text-justify">
            <li className="flex">
              <span className="mr-2">(a)</span>
              the Services are completed and the Agreed Price is released from
              the Payment Account;
            </li>
            <li className="flex">
              <span className="mr-2">(b)</span>a party is terminated or
              suspended from the TaskHub Platform, at the election of the other
              party;
            </li>
            <li className="flex">
              <span className="mr-2">(c)</span>otherwise agreed by the parties
              or the Third Party Dispute Service; or
            </li>
            <li className="flex">
          ...
          <div className=" text-[12px] flex flex-col space-y-4 text-justify">
            <p className="">
              ...
              means the most updated version of the agreement between TaskHub
              and a User.
            </p>
            <p>
            ...
            <p>
              ...
              means a badge that may be issued to a User based on the User
              meeting certain qualifications or other thresholds, including
              Verification Icons, as determined and set by TaskHub.
            </p>
            <p>
            ...
            <p>
              ...
              jurisdiction where Users have their TaskHub Platform account,
            ...
            <p>
              ...
              means a contract between a Business Partner and a Tasker to
              perform Business Services.
            </p>
            <p>
              <span className="mr-1 font-bold">"Business Partner"</span>
              means the business or individual that enters into an agreement
              with TaskHub to acquire Business Services.
            </p>
            <p>
              <span className="mr-1 font-bold">"Business Services"</span>
              means Services provided by a Tasker to a Business Partner acquired
              for the purpose of on selling to a third party (such as the
              Business Partner's customer)
            </p>
            <p>
              <span className="mr-1 font-bold">"Cancellation Admin Fee"</span>
              means the Fee payable by a Poster or a Tasker for cancelling a
              Task Contract and will not exceed 22% of the Agreed Price.
            </p>
            <p>
            ...
            <p>
              ...
              means a User that uses the TaskHub Platform to search for
              particular Services.
            </p>
            <p>
            ...
            <p>
              ...
              means any updates, news and special offers in relation to TaskHub
            ...
            <p>
              ...
              the exclusion of which would contravene the law or cause any part
              of the contract to be void. Further detail on the Non-excludable
              Conditions for consumers in the United Kingdom and in Ireland is
            ...
            <p>
              ...
              means the fee payable by the Poster to TaskHub as consideration
              for the TaskHub Services (and comprised as part of the Agreed
              Price) displayed to a Poster prior to entering into each Task
              Contract
            </p>
            <p>
              <span className="mr-1 font-bold">"Recurring Services"</span>
              means the same services procured by a Poster using the Search
              Assist feature from the same Tasker on a recurring basis, for
              example weekly, fortnightly or monthly.
            </p>
            <p>
            ...
            <p>
              ...
              means a feature of the TaskHub Platform whereby a Poster can
              submit specific details of a Posted Task with TaskHub's assistance
              to calculate the Agreed Price and find potential Taskers to
              perform the Services. This may also be referred to on the TaskHub
            ...
            <p>
              ...
              Tasker for Services. In the absence of, or in addition to, any
              terms specifically agreed, the model terms of which are included
              in Appendix A to the Agreement apply to Task Contracts.
            </p>
            <p>
              <span className="mr-1 font-bold">"Tasker"</span>
              means a User who provides Services to Posters. "Tasker Funds"
              means the Agreed Price less the Service Fee.
            </p>
            <p>
            ...
            <p>
              ...
              means the fee payable by the Tasker to TaskHub as consideration
              for the TaskHub Services (and comprised as part of the Agreed
              Price) displayed to a Tasker prior to entering into each Task
              Contract.
            </p>
            <p>
              <span className="mr-1 font-bold">
            ...
            <p>
              ...
              means the promotions and links to services offered by third
              parties as may be featured on the TaskHub Platform from time to
              time.
            </p>
            <p>
            ...
            <p>
              ...
              any such posts on the TaskHub Platform to confirm details such as
              a User's qualification, license, certificate or other skill.
            </p>
          </div>
          <p className="my-8 font-bold">
            Revised May 2023 copyright &copy; TaskHub 2024
