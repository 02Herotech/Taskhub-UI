        ...
        <div className=" mt-16 max-w-4xl mx-auto flex flex-col space-y-8">
          <div className="flex flex-col space-y-5">
            <h3 className="font-bold text-md">
              1.0 What this Policy is about?
            </h3>
            <div className="text-[14px] flex flex-col space-y-8 text-justify ml-8">
              <p>
                TaskHub is committed to providing quality services to you and
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="flex flex-col space-y-5 ml-8">
              ...
              <div className="text-[14px] flex flex-col space-y-8 text-justify ml-6">
                ...
                <p>
                  TaskHub will not charge any fee for your access request but
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div className="text-[14px] flex flex-col space-y-8 text-justify ml-8">
              <p>
                Is there any question you may like to ask about our privacy
                policy and the service we provide? You can reach out to us
            ...
            <div className="flex flex-col space-y-5 ml-8">
              ...
              <div className="text-[14px] flex flex-col space-y-8 text-justify ml-6">
                <p>
                  If you have any feedback or questions about this Privacy
                  policy or any other privacy-related practice, please contact
                  us via email above or telephone number:{" "}
                  <Link
                    href="tel:+6145000000"
                    className="text-[#FE9B07] hover:text-grey6"
                  >
